...
if ($_SERVER['REQUEST_METHOD'] == "POST" ) {
    if ($_FILES['inputfile']['error'] == UPLOAD_ERR_OK && $_FILES['inputfile']['type'] == 'image/jpeg') { //проверка на наличие ошибок
        $destiation_dir = '../foto/' . $_FILES['inputfile']['name']; // директория для размещения файла
            ...
            foreach ($dir as $key => $value) {
                if ('.' !== $value && '..' !== $value) {
                    ...
                    <div class="col-lg-3 col-md-4 col-6 thumb">
                        <a data-fancybox="gallery" href="../foto/<?php echo $value; ?>">
                            <img class="img-fluid" src="../foto/<?php echo $value; ?>" alt="Изображение" height="70%">
                        </a>
                    </div>
                    <?php
                }
